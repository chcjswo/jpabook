package com.mocadev.jpabook.jpashop;
...
public class InitDb {
	...
	static class InitService {
		...
		public void dbInit2() {
			Member member = createMember("userB", "pusan", "2", "2222");
			em.persist(member);

			Book book1 = createBook("SPRING1 BOOK", 30000, 100);
			em.persist(book1);

			Book book2 = createBook("SPRING2 BOOK", 40000, 110);
			em.persist(book2);
